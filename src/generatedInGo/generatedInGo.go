// ----------------------------------------------------------------------------
// This file was auto-generated on 2020-06-26
    ...
    for i := 1; i < len(data); i++ {    
        if i<len(data) {        
            ...
            if data[i] > data[i-1] {            
                ...
                if currentState == 's' {                
                    D = 0.0                    
                    R = math.Max(R_temp,add(add(D_temp,1.0),1.0))                    
                    currentState = 's'                    
                }                
            } else if data[i] == data[i-1] {            
                if currentState == 's' {                
        ...
        if i<len(data) {        
            ...
            if data[i] > data[i-1] {            
                ...
                if currentState == 's' {                
                    ...
                    D = 0.0                    
                    R = math.Max(R_temp,diff(D_temp,data[i-1]))                    
                    currentState = 't'                    
                }                
            } else if data[i] == data[i-1] {            
                if currentState == 's' {                
        ...
        if i<len(data) {        
            ...
            if data[i] > data[i-1] {            
                if currentState == 's' {                
                    ...
                    C = diff(D_temp,data[i-1])                    
                    D = 0.0                    
                    currentState = 't'                    
                } else if currentState == 't' {                
                    C = diff(C_temp,diff(D_temp,data[i-1]))                    
                    D = 0.0                    
                    currentState = 't'                    
                } else if currentState == 'u' {                
                    D = 0.0                    
    ...
    for i := 1; i < len(data); i++ {    
        if i<len(data) {        
            ...
            if data[i] > data[i-1] {            
                ...
                if currentState == 's' {                
                    D = 0.0                    
                    R = math.Min(R_temp,add(add(D_temp,1.0),1.0))                    
                    currentState = 's'                    
                }                
            } else if data[i] == data[i-1] {            
                if currentState == 's' {                
        ...
        if i<len(data) {        
            ...
            if data[i] > data[i-1] {            
                ...
                if currentState == 's' {                
                    ...
                    D = 0.0                    
                    R = math.Min(R_temp,diff(D_temp,data[i-1]))                    
                    currentState = 't'                    
                }                
            } else if data[i] == data[i-1] {            
                if currentState == 's' {                
    ...
    for i := 1; i < len(data); i++ {    
        if i<len(data) {        
            ...
            if data[i] > data[i-1] {            
                ...
                if currentState == 's' {                
                    D = 0.0                    
                    R = math.Min(R_temp,diff(diff(D_temp,data[i-1]),data[i]))                    
                    currentState = 's'                    
                }                
            } else if data[i] == data[i-1] {            
                if currentState == 's' {                
    ...
    for i := 1; i < len(data); i++ {    
        if i<len(data) {        
            ...
            if data[i] > data[i-1] {            
                ...
                if currentState == 's' {                
                    D = 0.0                    
                    R = add(R_temp,add(add(D_temp,1.0),1.0))                    
                    currentState = 's'                    
                }                
            } else if data[i] == data[i-1] {            
                if currentState == 's' {                
        ...
        if i<len(data) {        
            ...
            if data[i] > data[i-1] {            
                ...
                if currentState == 's' {                
                    ...
                    D = 0.0                    
                    R = add(R_temp,diff(D_temp,data[i-1]))                    
                    currentState = 't'                    
                }                
            } else if data[i] == data[i-1] {            
                if currentState == 's' {                
    ...
    for i := 1; i < len(data); i++ {    
        if i<len(data) {        
            ...
            if data[i] > data[i-1] {            
                ...
                if currentState == 's' {                
                    D = 0.0                    
                    R = add(R_temp,diff(diff(D_temp,data[i-1]),data[i]))                    
                    currentState = 's'                    
                }                
            } else if data[i] == data[i-1] {            
                if currentState == 's' {                
